...
(function (window) {
  ...
  // constructor
  var WebAudioRecorder = function (audioContext, configs) {
  ...
  extend(WebAudioRecorder.prototype, {
    ...
    setEncoding: function (encoding) {
      if (this.isRecording()) { this.error('setEncoding: cannot set encoding during recording') } else if (this.encoding !== encoding) {
    ...
    cancelEncoding: function () {
      if (this.options.encodeAfterRecord) {
        if (this.isRecording()) { this.error('cancelEncoding: recording is not finished') } else {
