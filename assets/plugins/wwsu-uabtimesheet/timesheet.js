...
socket.on('connect', function () {
    directorsdb.replaceData(noReq, '/uab/directors/get');
    timesheetsdb.replaceData(noReq, '/uab/timesheet/get');
});
...
function filterDate() {
    ...
    noReq.request({method: 'POST', url: '/uab/timesheet/get', data: {date: moment(thedate.value).toISOString(true)}}, (resHTML) => {
        try {
