...
module.exports=function(){function e(e,r,n){return function(e,r,n,t,a){for(var i=-1!==n?n:e.length,o=r;o<i;++o)if(0===e[o].indexOf(t)&&(!a||-1!==e[o].toLowerCase().indexOf(a.toLowerCase())))return o;return null}(e,0,-1,r,n)}function r(e){var r=new RegExp("a=rtpmap:(\\d+) \\w+\\/\\d+"),n=e.match(r);return n&&2===n.length?n[1]:null}return{setApplicationSpecificBandwidth:function(e,r,n){return function(e,r,n){return navigator.mozGetUserMedia||!r?e:(n&&(r.screen?r.screen<300&&console.warn("It seems that you are using wrong bandwidth value for screen. Screen sharing is expected to fail."):console.warn("It seems that you are not using bandwidth for screen. Screen sharing is expected to fail.")),r.screen&&n&&(e=(e=e.replace(/b=AS([^\r\n]+\r\n)/g,"")).replace(/a=mid:video\r\n/g,"a=mid:video\r\nb=AS:"+r.screen+"\r\n")),(r.audio||r.video||r.data)&&(e=e.replace(/b=AS([^\r\n]+\r\n)/g,"")),r.audio&&(e=e.replace(/a=mid:audio\r\n/g,"a=mid:audio\r\nb=AS:"+r.audio+"\r\n")),r.video&&(e=e.replace(/a=mid:video\r\n/g,"a=mid:video\r\nb=AS:"+(n?r.screen:r.video)+"\r\n")),e)}(e,r,n)},setVideoBitrates:function(n,t){return function(n,t){var a,i=(t=t||{}).min,o=t.max,d=n.split("\r\n"),u=e(d,"a=rtpmap","VP8/90000");if(u&&(a=r(d[u])),!a)return n;var s,c=e(d,"a=rtpmap","rtx/90000");if(c&&(s=r(d[c])),!c)return n;var p=e(d,"a=fmtp:"+s.toString());if(null!==p){var m="\r\n";m+="a=fmtp:"+a+" x-google-min-bitrate="+(i||"228")+"; x-google-max-bitrate="+(o||"228"),d[p]=d[p].concat(m),n=d.join("\r\n")}return n}(n,t)},setOpusAttributes:function(n,t){return function(n,t){t=t||{};var a,i=n.split("\r\n"),o=e(i,"a=rtpmap","opus/48000");if(o&&(a=r(i[o])),!a)return n;var d=e(i,"a=fmtp:"+a.toString());if(null===d)return n;var u="";return u+="; stereo="+(void 0!==t.stereo?t.stereo:"1"),u+="; sprop-stereo="+(void 0!==t["sprop-stereo"]?t["sprop-stereo"]:"1"),void 0!==t.maxaveragebitrate&&(u+="; maxaveragebitrate="+(t.maxaveragebitrate||1048576)),void 0!==t.maxplaybackrate&&(u+="; maxplaybackrate="+(t.maxplaybackrate||1048576)),void 0!==t.cbr&&(u+="; cbr="+(void 0!==t.cbr?t.cbr:"1")),void 0!==t.useinbandfec&&(u+="; useinbandfec="+t.useinbandfec),void 0!==t.usedtx&&(u+="; usedtx="+t.usedtx),void 0!==t["x-google-min-bitrate"]&&(u+="; x-google-min-bitrate="+t["x-google-min-bitrate"]),void 0!==t.maxptime&&(u+="\r\na=maxptime:"+t.maxptime),i[d]=i[d].concat(u),n=i.join("\r\n")}(n,t)}}}();
