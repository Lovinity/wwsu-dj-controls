parcelRequire = function(e, r, t, n) {
    ...
    "sXtV": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.RTCSessionDescription = window.RTCSessionDescription || window.mozRTCSessionDescription, exports.RTCPeerConnection = window.RTCPeerConnection || window.mozRTCPeerConnection || window.webkitRTCPeerConnection, exports.RTCIceCandidate = window.RTCIceCandidate || window.mozRTCIceCandidate;
    }, {}],
    "BHXf": [function(require, module, exports) {
        ...
        var r = n(require("js-binarypack")),
            ...
            o = function() {
                function e() {}
                var n;
                return e.noop = function() {}, e.validateId = function(e) {
                    ...
                    for (var n = new Uint8Array(e.length), r = 0; r < e.length; r++) n[r] = 255 & e.charCodeAt(r);
                    return n.buffer
                }, e.randomToken = function() {
                    return Math.random().toString(36).substr(2)
                }, e.isSecure = function() {
                    return "https:" === location.protocol
                }, e.CLOUD_HOST = "0.peerjs.com", e.CLOUD_PORT = 443, e.chunkedBrowsers = {
                    Chrome: 1
                }, e.chunkedMTU = 16300, e.defaultConfig = a, e.browser = (n = window).mozRTCPeerConnection ? "Firefox" : n.webkitRTCPeerConnection ? "Chrome" : n.RTCPeerConnection ? "Supported" : "Unsupported", e.supports = function() {
                    ...
                    return o && (o = !!e.addStream), e && e.close(), {
                        audioVideo: o,
                        data: r,
                        binaryBlob: i,
                        binary: u,
    ...
    "wJlv": [function(require, module, exports) {
        ...
        var e = this && this.__extends || function() {
            ...
            s = this && this.__spread || function() {
                for (var e = [], s = 0; s < arguments.length; s++) e = e.concat(t(arguments[s]));
                return e
            },
            ...
            a = function(t) {
                ...
                return e(o, t), o.prototype.start = function(e, t) {
                    ...
                    this._socket || (this._socket = new WebSocket(this._wsUrl), this._socket.onmessage = function(t) {
                        ...
                        i.default.log("Socket closed.", t), e._disconnected = !0, clearTimeout(e._wsPingTimer), e.emit(c.SocketEventType.Disconnected)
        ...
        var e = arguments[3],
            ...
            t = {
                ...
                binaryStringToArrayBuffer: function(e) {
                    for (var r = new Uint8Array(e.length), t = 0; t < e.length; t++) r[t] = 255 & e.charCodeAt(t);
                    return r.buffer
                },
    ...
    "aYFJ": [function(require, module, exports) {
        ...
        e.prototype.send = function(e) {
            ...
            for (var t in this._outgoing) this._outgoing.hasOwnProperty(t) && this._sendWindowedChunks(t)
            ...
            return t
        }, e.prototype.onmessage = function(t) {}, module.exports = e;
    }, {
        "./util": "T9kO"
    }],
        ...
        var e = this && this.__assign || function() {
            ...
            n = this && this.__awaiter || function(e, n, t, o) {
                return new(t || (t = Promise))(function(i, r) {
                    ...
                    function s(e) {
                        e.done ? i(e.value) : new t(function(n) {
                            n(e.value)
                        }).then(c, a)
                    }
        ...
        var r = o(require("reliable")),
            ...
            d = function() {
                ...
                return o.prototype.startConnection = function(e) {
                    ...
                    var e = {};
                    this.connection.type !== l.ConnectionType.Data || c.util.supports.sctp ? this.connection.type === l.ConnectionType.Media && (e = {
                        optional: [{
                    ...
                    a.default.log("Listening for ICE candidates."), e.onicecandidate = function(e) {
                        e.candidate && (a.default.log("Received ICE candidates for:", t), r.socket.send({
                    ...
                    return n(this, void 0, Promise, function() {
                        ...
                        return t(this, function(t) {
                            switch (t.label) {
                                ...
                                case 4:
                                    return t.sent(), a.default.log("Set localDescription:", i, "for:" + this.connection.peer), s = {
                                        sdp: i,
                                        type: this.connection.type,
                                        connectionId: this.connection.connectionId,
                                        metadata: this.connection.metadata,
                                        browser: c.util.browser
                                    }, this.connection.type === l.ConnectionType.Data && (d = this.connection, s = e({}, s, {
                                        label: d.label,
                                        reliable: d.reliable,
                    ...
                    return n(this, void 0, Promise, function() {
                        ...
                        return t(this, function(t) {
                            switch (t.label) {
                                ...
                                case 4:
                                    return t.sent(), a.default.log("Set localDescription:", o, "for:" + this.connection.peer), n.socket.send({
                    ...
                    return n(this, void 0, Promise, function() {
                        ...
                        return t(this, function(t) {
                            switch (t.label) {
                                ...
                                case 1:
                                    return t.trys.push([1, 3, , 4]), [4, i.addIceCandidate(new s.RTCIceCandidate({
                                        sdpMLineIndex: o,
                                        candidate: n
                                    }))];
                                case 2:
                    ...
                    a.default.log("add stream " + e.id + " to media connection " + n.connectionId), n.addStream(e)
                }, o
            }();
        ...
        var r = require("./util"),
            ...
            c = function(n) {
                function l(e, t, o) {
                    ...
                    return i._localStream = i.options._stream, i.connectionId = i.options.connectionId || l.ID_PREFIX + r.util.randomToken(), i._negotiator = new a.Negotiator(i), i._localStream && i._negotiator.startConnection({
                        _stream: i._localStream,
                        originator: !0
                    }), i
                }
                return e(l, n), Object.defineProperty(l.prototype, "type", {
                    get: function() {
                    ...
                    i.default.log("Receiving stream", e), this._remoteStream = e, n.prototype.emit.call(this, s.ConnectionEventType.Stream, e)
                    ...
                    if (this._localStream) i.default.warn("Local stream already exists on this MediaConnection. Are you answering a call twice?");
                        ...
                        this._localStream = e, this._negotiator.startConnection(t({}, this.options._payload, {
                            _stream: e
                        }));
                    ...
                    if (this._negotiator && (this._negotiator.cleanup(), this._negotiator = null), this._localStream = null, this._remoteStream = null, this.provider) {
                        var e = this.provider.connections[this.peer];
                        if (e) {
                            var t = e.indexOf(this); - 1 !== t && e.splice(t, 1)
                        }
                        this.provider = null
                    }
                    this.options && this.options._stream && (this.options._stream = null), this.open && (this._open = !1, n.prototype.emit.call(this, s.ConnectionEventType.Close))
                }, l.ID_PREFIX = "mc_", l
            }(l.BaseConnection);
        ...
        var i = require("reliable"),
            ...
            u = function(n) {
                ...
                return e(l, n), Object.defineProperty(l.prototype, "type", {
                    ...
                    enumerable: !0,
                    configurable: !0
                }), Object.defineProperty(l.prototype, "dataChannel", {
                    get: function() {
                        return this._dc
                    },
                    enumerable: !0,
                ...
                }, l.prototype._configureDataChannel = function() {
                    var e = this;
                    if (r.util.supports.sctp && (this.dataChannel.binaryType = "arraybuffer"), this.dataChannel.onopen = function() {
                            o.default.log("Data channel connection success"), e._open = !0, e.emit(s.ConnectionEventType.Open)
                    ...
                    if (this.serialization === s.SerializationType.Binary || this.serialization === s.SerializationType.BinaryUTF8) {
                        if (o === Blob) return void r.util.blobToArrayBuffer(i, function(e) {
                            i = r.util.unpack(e), t.emit(s.ConnectionEventType.Data, i)
                        });
                    ...
                    if (i.__peerData) {
                        var l = i.__peerData,
                            u = this._chunkedData[l] || {
                                data: [],
                                count: 0,
                                total: i.total
                            };
                        return u.data[i.n] = i.data, u.count++, u.total === u.count && (delete this._chunkedData[l], i = new Blob(u.data), this._handleDataMessage({
                            data: i
                        })), void(this._chunkedData[l] = u)
                    }
                    n.prototype.emit.call(this, s.ConnectionEventType.Data, i)
                }, l.prototype.close = function() {
                    if (this._buffer = [], this._bufferSize = 0, this._negotiator && (this._negotiator.cleanup(), this._negotiator = null), this.provider) {
                        var e = this.provider.connections[this.peer];
                        if (e) {
                            var t = e.indexOf(this); - 1 !== t && e.splice(t, 1)
                        }
                    ...
                    this.open && (this._open = !1, n.prototype.emit.call(this, s.ConnectionEventType.Close))
                    ...
                    if (this.open)
                        ...
                        r.util.supports.sctp ? r.util.supports.binaryBlob ? this._bufferedSend(o) : r.util.blobToArrayBuffer(o, function(e) {
                            i._bufferedSend(e)
                    ...
                    return !0
                }, l.prototype._tryBuffer = function() {
                ...
                }, l.prototype._sendChunks = function(e) {
        ...
        var i = require("eventemitter3"),
            ...
            f = function(o) {
                function i(e, n) {
                    ...
                    return r._destroyed = !1, r._disconnected = !1, r._open = !1, r._connections = new Map, r._lostMessages = new Map, e && e.constructor == Object ? (n = e, e = void 0) : e && (e = e.toString()), n = t({
                        debug: 0,
                    ...
                    }, n), r._options = n, "/" === n.host && (n.host = window.location.hostname), "/" !== n.path[0] && (n.path = "/" + n.path), "/" !== n.path[n.path.length - 1] && (n.path += "/"), void 0 === n.secure && n.host !== s.util.CLOUD_HOST ? n.secure = s.util.isSecure() : n.host == s.util.CLOUD_HOST && (n.secure = !0), n.logFunction && a.default.setLogFunction(n.logFunction), a.default.logLevel = n.debug, s.util.supports.audioVideo || s.util.supports.data ? s.util.validateId(e) ? (r._api = new p.API(n), r._initializeServerConnection(), e ? r._initialize(e) : r._api.retrieveId().then(function(e) {
                        return r._initialize(e)
                    }).catch(function(e) {
                        return r._abort(d.PeerErrorType.ServerError, e)
                    }), r) : (r._delayedAbort(d.PeerErrorType.InvalidID, 'ID "' + e + '" is invalid'), r) : (r._delayedAbort(d.PeerErrorType.BrowserIncompatible, "The current browser does not support WebRTC"), r)
                }
                return e(i, o), Object.defineProperty(i.prototype, "id", {
                    ...
                    var e = this;
                    this._socket = new c.Socket(this._options.secure, this._options.host, this._options.port, this._options.path, this._options.key), this.socket.on(d.SocketEventType.Message, function(t) {
                        e._handleMessage(t)
                    ...
                    a.default.error("Aborting!"), this._lastServerId ? this.disconnect() : this.destroy(), this.emitError(e, t)
                }, i.prototype.emitError = function(e, t) {
                    a.default.error("Error:", t), "string" == typeof t && (t = new Error(t)), t.type = e, this.emit(d.PeerEventType.Error, t)
