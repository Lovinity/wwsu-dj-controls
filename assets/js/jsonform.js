 ...
 */
  ...
  '<% } %>' +
  '</div>' +
  '<a href="#" class="btn btn-default _jsonform-delete"><i class="fas fa-minus-circle" title="Remove"></i></a> '
  ...
  jsonform.elementTypes = {
    ...
    array: {
      ...
      '<span class="_jsonform-array-buttons">' +
        '<a href="#" class="btn btn-default _jsonform-array-addmore"><i class="fas fa-plus-circle" title="Add new"></i></a> ' +
        '<a href="#" class="btn btn-default _jsonform-array-deletelast"><i class="fas fa-minus-circle" title="Delete last"></i></a>' +
      '</span>' +
      '</div>',
      fieldtemplate: true,
      array: true,
      childTemplate: function (inner) {
        ...
        // floating to the left of the main element
          ...
          '<span class="draggable line"><i class="fas fa-list" title="Move item"></i></span>' +
          inner +
          '</li>'
        } else {
          return '<li data-idx="<%= node.childPos %>">' +
    ...
    tabarray: {
      ...
      '</div>' +
      '</div>' +
      '<a href="#" class="btn btn-default _jsonform-array-addmore"><i class="fas fa-plus" title="Add new"></i></a> ' +
      '<a href="#" class="btn btn-default _jsonform-array-deleteitem"><i class="fas fa-minus" title="Delete item"></i></a></div>',
      fieldtemplate: true,
      array: true,
      childTemplate: function (inner) {
  ...
  formNode.prototype.enhance = function () {
    ...
    // event handler to be run right away
      ...
      // Register specific event handlers
        ...
        if (this.onChange) { $(this.el).bind('change', function (evt) { node.onChange(evt, node) }) }
        if (this.view.onChange) { $(this.el).bind('change', function (evt) { node.view.onChange(evt, node) }) }
        if (this.formElement.onChange) { $(this.el).bind('change', function (evt) { node.formElement.onChange(evt, node) }) }

        if (this.onClick) { $(this.el).bind('click', function (evt) { node.onClick(evt, node) }) }
        if (this.view.onClick) { $(this.el).bind('click', function (evt) { node.view.onClick(evt, node) }) }
        if (this.formElement.onClick) { $(this.el).bind('click', function (evt) { node.formElement.onClick(evt, node) }) }

        if (this.onKeyUp) { $(this.el).bind('keyup', function (evt) { node.onKeyUp(evt, node) }) }
        if (this.view.onKeyUp) { $(this.el).bind('keyup', function (evt) { node.view.onKeyUp(evt, node) }) }
        if (this.formElement.onKeyUp) { $(this.el).bind('keyup', function (evt) { node.formElement.onKeyUp(evt, node) }) }
