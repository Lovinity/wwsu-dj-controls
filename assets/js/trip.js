                        ...
                        /***/ function (module, exports, __webpack_require__) {
                            ...
                            Trip.prototype = {
                                ...
                                showExposedElements: function () {
                                    ...
                                    if ($sel.get(0) !== undefined) {
                                        ...
                                        newCSS = {
                                            ...
                                            "z-index": this.settings.exposeZIndex + 1
                                        };
                                ...
                                showCurrentTrip: function (o) {
                                    ...
                                    if (this.settings.overlayZIndex === 99999)
                                    {
                                        var $sel;
                                        if (typeof o.expose === 'string') {
                                            $sel = $(o.expose);
                                        ...
                                        var zIndex = $sel.css("z-index");
                                        var $sel2 = $sel;

                                        console.log(`pre-ZINDEX: ${zIndex}`);
                                        while (zIndex === 'auto')
                                        {
                                            $sel2 = $sel2.parent();
                                            if (typeof $sel2.css === 'undefined')
                                            {
                                                zIndex = 1;
                                            } else {
                                                try {
                                                    zIndex = $sel2.css("z-index");
                                                } catch (e) {
                                                    zIndex = 1;
                                                }
                                            }
                                            console.log(`loop ZINDEX: ${zIndex}`);
                                        }

                                        zIndex = parseInt(zIndex);
                                        console.log(`ZINDEX: ${zIndex}`);

                                        this.settings.exposeZIndex = zIndex + 1;
                                        this.settings.tripZIndex = zIndex + 1;
                                        this.settings.overlayZIndex2 = zIndex;

                                        this.$overlay.css("z-index", parseInt(zIndex + 1));
                                    } else {
                                        this.settings.exposeZIndex = this.settings.overlayZIndex + 1;
                                        this.settings.tripZIndex = this.settings.overlayZIndex + 1;
                                        this.settings.overlayZIndex2 = this.settings.overlayZIndex;
                                    }
                                ...
                                showTripBlock: function (o) {
                                    this.$tripBlock.css({
                                        ...
                                        // we have to make it higher than the overlay
                                        "z-index": this.settings.tripZIndex + 2
                                    });
                                ...
                                createOverlay: function () {
                                    ...
                                    if (typeof $('.trip-overlay').get(0) === 'undefined') {
                                        ...
                                        $overlay
                                                ...
                                                .css({
                                                    "z-index": this.settings.overlayZIndex2
                                                });
