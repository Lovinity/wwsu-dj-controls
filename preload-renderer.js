...
contextBridge.exposeInMainWorld("ipc", {
	...
	audioRecorderSetting: args => ipcRenderer.send("audioRecorderSetting", args),
	...
	remote: {
		...
		answerCall: args => ipcRenderer.send("remote", ["remoteAnswerCall", args]),
		peerCredential: args =>
...
contextBridge.exposeInMainWorld("settings", {
	...
	renderer: () => ipcRenderer.sendSync("settings", "renderer")
});
...
contextBridge.exposeInMainWorld("saveSettings", {
	...
	renderer: (key, value) =>
		ipcRenderer.send("saveSettings", [`renderer.${key}`, value])
});
